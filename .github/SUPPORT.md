# Getting help with StatConsultUtils

Thanks for using StatConsultUtils. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/StatConsultUtils/issues) to make sure the 
